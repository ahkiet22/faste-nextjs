  ...
  return (
    <>
      ...
      <Box sx={{ width: '100%' }}>
        ...
        {!editComment && (
          <Box sx={{ display: 'flex', gap: 1, ml: '70px' }}>
            <IconButton color='primary' sx={{ height: '30px', backgroundColor: 'transparent !important' }}>
              <Icon icon='mdi:like-outline' />
            </IconButton>
            <IconButton color='error' sx={{ height: '30px', backgroundColor: 'transparent !important' }}>
              <Icon icon='mdi:dislike-outline' />
            </IconButton>
            <Button
              variant='text'
              sx={{ height: '30px', backgroundColor: 'transparent !important' }}
